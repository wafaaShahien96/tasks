            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        {{-- <a class="dropdown-item" href="{{url('profiles/show')}}"><i class="bx bx-user-circle"></i>Profile</a> --}}
                        <a class="dropdown-item" href="{{ url('profiles/edit') }}"><i class="bx bx-cog"></i>Profile</a>
